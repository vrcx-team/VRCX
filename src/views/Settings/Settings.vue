        ...
        <el-tabs type="card" style="height: calc(100% - 51px)">
            ...
            <el-tab-pane :label="t('view.settings.category.general')">
                ...
                <div class="options-container">
                    ...
                    <div class="options-container-item">
                        ...
                        <br />
                        <el-radio-group :value="autoUpdateVRCX" size="mini" style="margin-top: 5px"
                ...
                <div class="options-container">
                    ...
                    <simple-switch v-if="!isLinux" :label="t('view.settings.general.application.startup')"
                        :value="isStartAtWindowsStartup" @change="setIsStartAtWindowsStartup" />
                    <simple-switch v-if="!isLinux" :label="t('view.settings.general.application.minimized')"
                        :value="isStartAsMinimizedState" @change="setIsStartAsMinimizedState" />
                    <simple-switch v-else :label="t('view.settings.general.application.minimized')"
                        :value="isStartAsMinimizedState" :tooltip="t('view.settings.general.application.startup_linux')"
                        @change="setIsStartAsMinimizedState" />
                    <simple-switch :label="t('view.settings.general.application.tray')" :value="isCloseToTray"
                        @change="setIsCloseToTray" />
                    <simple-switch v-if="!isLinux"
                ...
                <div class="options-container">
                    ...
                    <br />
                    <el-select :value="localFavoriteFriendsGroups" multiple clearable
                        :placeholder="t('view.settings.general.favorites.group_placeholder')" style="margin-top: 8px"
                        @change="setLocalFavoriteFriendsGroups">
                        <el-option-group :label="t('view.settings.general.favorites.group_placeholder')">
                            <el-option v-for="group in favoriteFriendGroups" :key="group.key" :label="group.displayName"
                                :value="group.key" class="x-friend-item">
                                <div class="detail">
                ...
                <div class="options-container">
                    ...
                    <simple-switch :label="t('view.settings.advanced.advanced.cache_debug.udon_exception_logging')"
                        :value="udonExceptionLogging" @change="
                            setUdonExceptionLogging();
                        saveOpenVROption();
                        " />
                    <simple-switch :label="t('view.settings.general.logging.resource_load')" :value="logResourceLoad"
                        @change="setLogResourceLoad" />
                    <simple-switch :label="t('view.settings.general.logging.empty_avatar')" :value="logEmptyAvatars"
                        @change="setLogEmptyAvatars" />
                </div>
                <!--//- General | Automation-->
                <div class="options-container">
                    <span class="header">{{ t('view.settings.general.automation.header') }}</span>
                    <simple-switch :label="t('view.settings.general.automation.auto_change_status')"
                    ...
                    <div class="options-container-item">
                        ...
                        <el-select :value="autoStateChangeAloneStatus" :disabled="!autoStateChangeEnabled"
                            style="margin-top: 8px" size="small" @change="setAutoStateChangeAloneStatus">
                    ...
                    <div class="options-container-item">
                        ...
                        <el-select :value="autoStateChangeCompanyStatus" :disabled="!autoStateChangeEnabled"
                            style="margin-top: 8px" size="small" @change="setAutoStateChangeCompanyStatus">
                            <el-option :label="t('dialog.user.status.join_me')" value="join me">
                                <i class="x-user-status joinme"></i> {{ t('dialog.user.status.join_me') }}
                            </el-option>
                            <el-option :label="t('dialog.user.status.online')" value="active">
                    ...
                    <div class="options-container-item">
                        ...
                        <el-select :value="autoStateChangeInstanceTypes" :disabled="!autoStateChangeEnabled" multiple
                            clearable :placeholder="t('view.settings.general.automation.instance_type_placeholder')"
                            style="margin-top: 8px" size="small" @change="setAutoStateChangeInstanceTypes">
                            <el-option-group :label="t('view.settings.general.automation.allowed_instance_types')">
                                <el-option v-for="instanceType in instanceTypes" :key="instanceType"
                                    :label="instanceType" :value="instanceType" class="x-friend-item">
                                    <div class="detail">
                    ...
                    <div class="options-container-item">
                        ...
                        <el-radio-group :value="autoStateChangeNoFriends" :disabled="!autoStateChangeEnabled"
                    ...
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.general.automation.auto_invite_request_accept') }}
                        ...
                        <br />
                        <el-radio-group :value="autoAcceptInviteRequests" size="mini" style="margin-top: 5px"
                ...
                <div class="options-container">
                    ...
                    <div class="options-container-item">
                        <img src="https://contrib.rocks/image?repo=vrcx-team/VRCX" alt="Contributors"
            ...
            <el-tab-pane lazy :label="t('view.settings.category.appearance')">
                <div class="options-container" style="margin-top: 0">
                    ...
                    <div class="options-container-item">
                        ...
                        <el-dropdown trigger="click" size="small" @click.native.stop>
                            <el-button size="mini">
                                <span>{{ messages[appLanguage]?.language }}
                                    <i class="el-icon-arrow-down el-icon--right"></i></span>
                            </el-button>
                            <el-dropdown-menu>
                                <el-dropdown-item v-for="(obj, language) in messages" :key="language"
                                    @click.native="changeAppLanguage(language)" v-text="obj.language" />
                            </el-dropdown-menu>
                        </el-dropdown>
                    </div>
                    <div class="options-container-item">
                        ...
                        <el-dropdown trigger="click" size="small" @click.native.stop>
                            <el-button size="mini">
                                <span>{{ t(`view.settings.appearance.appearance.theme_mode_${themeMode}`) }}
                                    <i class="el-icon-arrow-down el-icon--right"></i></span>
                            </el-button>
                            <el-dropdown-menu>
                                <el-dropdown-item v-for="(config, themeKey) in THEME_CONFIG" :key="themeKey"
                    ...
                    <div v-if="!isLinux" class="options-container-item">
                        ...
                        <el-input-number v-model="zoomLevel" size="small" :precision="0" style="width: 128px"
                            @change="setZoomLevel" />
                    </div>
                    <simple-switch :label="t('view.settings.appearance.appearance.vrcplus_profile_icons')"
                        :value="displayVRCPlusIconsAsAvatar" @change="
                            setDisplayVRCPlusIconsAsAvatar();
                        saveOpenVROption();
                        " />
                    <simple-switch :label="t('view.settings.appearance.appearance.nicknames')" :value="!hideNicknames"
                        @change="
                            setHideNicknames();
                        saveOpenVROption();
                        " />
                    <simple-switch :label="t('view.settings.appearance.appearance.tooltips')" :value="!hideTooltips"
                        @change="
                            setHideTooltips();
                        saveOpenVROption();
                        " />
                    <simple-switch :label="t('view.settings.appearance.appearance.age_gated_instances')"
                        :value="isAgeGatedInstancesVisible" @change="setIsAgeGatedInstancesVisible" />
                    <simple-switch :label="t('view.settings.appearance.appearance.use_vscode_like_editor_to_show_json')"
                        :value="useVscodeLikeEditorToShowJSON" @change="setUseVscodeLikeEditorToShowJSON" />
                    <div class="options-container-item">
                    ...
                    <div class="options-container-item">
                        ...
                        <el-radio-group :value="instanceUsersSortAlphabetical"
                    ...
                    <div class="options-container-item">
                        <el-button size="small" icon="el-icon-notebook-1" style="margin-right: 10px"
                            @click="promptMaxTableSizeDialog">{{ t('view.settings.appearance.appearance.table_max_size')
                            }}</el-button>
                        <el-dropdown trigger="click" size="small" @click.native.stop>
                            <el-button size="small">
                                <span>{{ t('view.settings.appearance.appearance.page_size') }} {{ tablePageSize }}
                                    <i class="el-icon-arrow-down el-icon--right"></i></span>
                            </el-button>
                            <el-dropdown-menu>
                                <el-dropdown-item v-for="number in [10, 15, 20, 25, 50, 100]" :key="number"
                                    @click.native="handleSetTablePageSize(number)" v-text="number" />
                            </el-dropdown-menu>
                        </el-dropdown>
                    </div>
                    <div class="options-container-item" />
                ...
                <div class="options-container">
                    ...
                    <div class="options-container-item">
                        ...
                        <el-radio-group :value="dtHour12" @change="
                            setDtHour12();
                        updateVRConfigVars();
                        ">
                            <el-radio :label="true">{{
                    ...
                    <simple-switch :label="t('view.settings.appearance.timedate.force_iso_date_format')"
                        :value="dtIsoFormat" @change="setDtIsoFormat" />
                </div>
                ...
                <div class="options-container">
                    ...
                    <div class="options-container-item">
                        ...
                        <el-select :value="sidebarSortMethod1" style="width: 170px"
                            :placeholder="t('view.settings.appearance.side_panel.sorting.placeholder')" @change="
                        ...
                        <el-select :value="sidebarSortMethod2" :disabled="!sidebarSortMethod1" style="width: 170px"
                            clearable :placeholder="t('view.settings.appearance.side_panel.sorting.placeholder')"
                            @change="
                        ...
                        <i class="el-icon-arrow-right" style="margin: 16px 5px"></i>
                        <el-select :value="sidebarSortMethod3" :disabled="!sidebarSortMethod2" style="width: 170px"
                            clearable :placeholder="t('view.settings.appearance.side_panel.sorting.placeholder')"
                            @change="
                    ...
                    <div class="options-container-item">
                        ...
                        <el-slider :value="asideWidth" :show-tooltip="false" :marks="{ 300: '' }" :min="200" :max="500"
                            style="display: inline-block; width: 300px" @input="setAsideWidth"></el-slider>
                    </div>
                    ...
                    <simple-switch v-if="isSidebarGroupByInstance"
                    ...
                    <simple-switch :label="t('view.settings.appearance.side_panel.split_favorite_friends')"
                ...
                <div class="options-container">
                    ...
                    <simple-switch :label="t('view.settings.appearance.user_dialog.vrchat_notes')"
                        :value="!hideUserNotes" @change="setHideUserNotes" />
                    <simple-switch :label="t('view.settings.appearance.user_dialog.vrcx_memos')" :value="!hideUserMemos"
                    ...
                    <div class="options-container-item">
                        ...
                        <br />
                        <el-button size="small" icon="el-icon-document-copy" style="margin-top: 5px"
                            @click="showNoteExportDialog">{{ t('view.settings.appearance.user_dialog.export_notes')
                            }}</el-button>
                    </div>
                ...
                <div class="options-container">
                    ...
                    <simple-switch :label="t('view.settings.appearance.friend_log.hide_unfriends')"
                        :value="hideUnfriends" @change="setHideUnfriends"></simple-switch>
                </div>
                <!--//- Appearance | User Colors-->
                <div class="options-container">
                    <span class="header">{{ t('view.settings.appearance.user_colors.header') }}</span>
                    <simple-switch :label="t('view.settings.appearance.user_colors.random_colors_from_user_id')"
                        :value="randomUserColours" @change="updateTrustColor('', '', true)"></simple-switch>
                    <div class="options-container-item">
                        <div>
                            <el-color-picker :value="trustColor.untrusted" size="mini" :predefine="['#CCCCCC']"
                                @change="updateTrustColor('untrusted', $event)">
                            </el-color-picker>
                            <span slot="trigger" class="color-picker x-tag-untrusted">Visitor</span>
                        </div>
                        <div>
                            <el-color-picker :value="trustColor.basic" size="mini" :predefine="['#1778ff']"
                                @change="updateTrustColor('basic', $event)">
                            </el-color-picker>
                            <span slot="trigger" class="color-picker x-tag-basic">New User</span>
                        </div>
                        <div>
                            <el-color-picker :value="trustColor.known" size="mini" :predefine="['#2bcf5c']"
                                @change="updateTrustColor('known', $event)">
                            </el-color-picker>
                            <span slot="trigger" class="color-picker x-tag-known">User</span>
                        </div>
                        <div>
                            <el-color-picker :value="trustColor.trusted" size="mini" :predefine="['#ff7b42']"
                                @change="updateTrustColor('trusted', $event)">
                            </el-color-picker>
                            <span slot="trigger" class="color-picker x-tag-trusted">Known User</span>
                        </div>
                        <div>
                            <el-color-picker :value="trustColor.veteran" size="mini"
                        ...
                        <div>
                            <el-color-picker :value="trustColor.vip" size="mini" :predefine="['#ff2626']"
                                @change="updateTrustColor('vip', $event)">
                            </el-color-picker>
                            <span slot="trigger" class="color-picker x-tag-vip">VRChat Team</span>
                        </div>
                        <div>
                            <el-color-picker :value="trustColor.troll" size="mini" :predefine="['#782f2f']"
            ...
            <el-tab-pane lazy :label="t('view.settings.category.notifications')">
                ...
                <div class="options-container">
                    ...
                    <div class="options-container-item">
                        ...
                        <br />
                        <el-radio-group :value="overlayToast" size="mini" :disabled="(!overlayNotifications || !openVR) &&
                            !xsNotifications &&
                    ...
                    <template>
                        <simple-switch :label="t('view.settings.notifications.notifications.steamvr_notifications.steamvr_overlay')
                            " :value="openVR" @change="
                                setOpenVR();
                            saveOpenVROption();
                            " />
                        <simple-switch :label="t(
                            'view.settings.notifications.notifications.steamvr_notifications.overlay_notifications'
                        )
                            " :value="overlayNotifications" :disabled="!openVR" @change="
                                setOverlayNotifications();
                            saveOpenVROption();
                            " />
                        <div class="options-container-item">
                            <el-button size="small" icon="el-icon-rank" :disabled="!overlayNotifications || !openVR"
                        ...
                        <div class="options-container-item">
                            ...
                            <el-slider :value="notificationOpacity" @input="setNotificationOpacity"
                                :show-tooltip="false" :min="0" :max="100" show-input
                        ...
                        <simple-switch
                            ...
                            :value="imageNotifications" @change="
                    ...
                    <template v-if="!isLinux">
                        <simple-switch :label="t(
                            ...
                            " :value="ovrtHudNotifications" @change="
                        ...
                        <simple-switch :label="t(
                            ...
                            " :value="ovrtWristNotifications" @change="
                ...
                <div class="options-container">
                    ...
                    <div class="options-container-item">
                        ...
                        <br />
                        <el-radio-group :value="desktopToast" size="mini" style="margin-top: 5px" @input="
                ...
                <div class="options-container">
                    ...
                    <div class="options-container-item">
                        ...
                        <br />
                        <el-radio-group :value="notificationTTS" size="mini" style="margin-top: 5px"
                    ...
                    <div class="options-container-item">
                        ...
                        <el-dropdown trigger="click" size="small" @command="(voice) => changeTTSVoice(voice)">
                            ...
                            <el-dropdown-menu>
                                <el-dropdown-item v-for="(voice, index) in TTSvoices" :key="index" :command="index"
                                    v-text="voice.name" />
                            </el-dropdown-menu>
                        </el-dropdown>
                    </div>
                    <simple-switch
                        ...
                        :value="notificationTTSNickName" :disabled="notificationTTS === 'Never'" @change="
                            setNotificationTTSNickName();
                        saveOpenVROption();
                        " />
                    <simple-switch
                        :label="t('view.settings.notifications.notifications.text_to_speech.tts_test_placeholder')"
                        :value="isTestTTSVisible" @change="isTestTTSVisible = !isTestTTSVisible" />
                    <div v-if="isTestTTSVisible" style="margin-top: 5px">
                        <el-input v-model="notificationTTSTest" type="textarea" :placeholder="t('view.settings.notifications.notifications.text_to_speech.tts_test_placeholder')
                            " :rows="1" style="width: 175px; display: inline-block"></el-input>
                        <el-button size="small" icon="el-icon-video-play" style="margin-left: 10px"
            ...
            <el-tab-pane lazy :label="t('view.settings.category.wrist_overlay')">
                ...
                <div class="options-container" style="margin-top: 0">
                    ...
                    <div class="options-container-item">
                        <el-button size="small" icon="el-icon-notebook-2" :disabled="!openVR || !overlayWrist"
                    ...
                    <simple-switch :label="t('view.settings.wrist_overlay.steamvr_wrist_overlay.steamvr_overlay')"
                        :value="openVR" @change="
                            setOpenVR();
                        saveOpenVROption();
                        " />
                    <simple-switch :label="t('view.settings.wrist_overlay.steamvr_wrist_overlay.wrist_feed_overlay')"
                        :value="overlayWrist" :disabled="!openVR" @change="
                            setOverlayWrist();
                        saveOpenVROption();
                        "></simple-switch>
                    <simple-switch :label="t('view.settings.wrist_overlay.steamvr_wrist_overlay.hide_private_worlds')"
                        :value="hidePrivateFromFeed" @change="
                    ...
                    <div class="options-container-item" style="min-width: 118px">
                        ...
                        <el-radio-group :value="openVRAlways" :disabled="!openVR" @change="
                            setOpenVRAlways();
                        saveOpenVROption();
                        ">
                    ...
                    <div class="options-container-item">
                        ...
                        <el-radio-group :value="overlaybutton" :disabled="!openVR || !overlayWrist" @change="
                            setOverlaybutton();
                        saveOpenVROption();
                        ">
                            <el-radio :label="false">{{
                    ...
                    <div class="options-container-item">
                        ...
                        <el-radio-group :value="overlayHand" size="mini" @input="
                    ...
                    <simple-switch :label="t('view.settings.wrist_overlay.steamvr_wrist_overlay.grey_background')"
                        :value="vrBackgroundEnabled" :disabled="!openVR || !overlayWrist" @change="
                            setVrBackgroundEnabled();
                        saveOpenVROption();
                        " />
                    <simple-switch :label="t('view.settings.wrist_overlay.steamvr_wrist_overlay.minimal_feed_icons')"
                        :value="minimalFeed" :disabled="!openVR || !overlayWrist" @change="
                            setMinimalFeed();
                        saveOpenVROption();
                        " />
                    <simple-switch :label="t('view.settings.wrist_overlay.steamvr_wrist_overlay.show_vr_devices')"
                        :value="!hideDevicesFromFeed" :disabled="!openVR || !overlayWrist" @change="
                            setHideDevicesFromFeed();
                        saveOpenVROption();
                        " />
                    <simple-switch :label="t('view.settings.wrist_overlay.steamvr_wrist_overlay.show_cpu_usage')"
                        :value="vrOverlayCpuUsage" :disabled="!openVR || !overlayWrist" @change="
                            setVrOverlayCpuUsage();
                        saveOpenVROption();
                        " />
                    <simple-switch :label="t('view.settings.wrist_overlay.steamvr_wrist_overlay.show_game_uptime')"
                        :value="!hideUptimeFromFeed" :disabled="!openVR || !overlayWrist" @change="
                            setHideUptimeFromFeed();
                        saveOpenVROption();
                        " />
                    <simple-switch :label="t('view.settings.wrist_overlay.steamvr_wrist_overlay.show_pc_uptime')"
                        :value="pcUptimeOnFeed" :disabled="!openVR || !overlayWrist" @change="
                            setPcUptimeOnFeed();
                        saveOpenVROption();
                        "></simple-switch>
                </div>
            ...
            <el-tab-pane lazy :label="t('view.settings.category.discord_presence')">
                <div class="options-container" style="margin-top: 0">
                    ...
                    <br />
                    <simple-switch :label="t('view.settings.discord_presence.discord_presence.enable')"
                        :value="discordActive" @change="
                            setDiscordActive();
                        saveDiscordOption();
                        " />
                    <simple-switch :label="t('view.settings.discord_presence.discord_presence.world_integration')"
                        :value="discordWorldIntegration" :disabled="!discordActive" @change="
                    ...
                    <simple-switch
                        ...
                        :value="discordInstance" :disabled="!discordActive" @change="
                            setDiscordInstance();
                        saveDiscordOption();
                        " />
                    <simple-switch :label="t('view.settings.discord_presence.discord_presence.show_current_platform')"
                        :value="discordShowPlatform" :disabled="!discordActive || !discordInstance" @change="
                            setDiscordShowPlatform();
                        saveDiscordOption();
                        " />
                    <simple-switch :label="t('view.settings.discord_presence.discord_presence.show_details_in_private')"
                        :value="!discordHideInvite" :disabled="!discordActive" @change="
                            setDiscordHideInvite();
                        saveDiscordOption();
                        " />
                    <simple-switch :label="t('view.settings.discord_presence.discord_presence.join_button')"
                        :value="discordJoinButton" :disabled="!discordActive" @change="
                            setDiscordJoinButton();
                        saveDiscordOption();
                        " />
                    <simple-switch :label="t('view.settings.discord_presence.discord_presence.show_images')"
                        :value="!discordHideImage" :disabled="!discordActive" @change="
                            setDiscordHideImage();
                        saveDiscordOption();
                        " />
                    <simple-switch :label="t('view.settings.discord_presence.discord_presence.display_world_name_as_discord_status')
                        " :value="discordWorldNameAsDiscordStatus" :disabled="!discordActive" @change="
            ...
            <el-tab-pane lazy :label="t('view.settings.category.pictures')">
                ...
                <div class="options-container" style="margin-top: 0">
                    ...
                    <div class="options-container-item" style="margin-top: 15px">
                        <el-button-group><el-button size="small" icon="el-icon-picture"
                                @click="showScreenshotMetadataDialog()">{{
                ...
                <div class="options-container">
                    ...
                    <simple-switch :label="t('view.settings.advanced.advanced.screenshot_helper.enable')"
                        :value="screenshotHelper" @change="setScreenshotHelper()"
                        :tooltip="t('view.settings.advanced.advanced.screenshot_helper.description_tooltip')"
                        :long-label="true" />
                    <simple-switch :label="t('view.settings.advanced.advanced.screenshot_helper.modify_filename')"
                        :value="screenshotHelperModifyFilename" @change="setScreenshotHelperModifyFilename()"
                        :disabled="!screenshotHelper"
                        :tooltip="t('view.settings.advanced.advanced.screenshot_helper.modify_filename_tooltip')"
                        :long-label="true" />
                    <simple-switch :label="t('view.settings.advanced.advanced.screenshot_helper.copy_to_clipboard')"
                        :value="screenshotHelperCopyToClipboard" @change="setScreenshotHelperCopyToClipboard()"
                        :long-label="true" />
                ...
                <div class="options-container">
                    ...
                    <simple-switch :label="t('view.settings.pictures.pictures.auto_delete_prints_from_vrc')"
                        :value="autoDeleteOldPrints" @change="setAutoDeleteOldPrints()" :long-label="true" />
                </div>
                ...
                <div class="options-container">
                    ...
                    <simple-switch
                        ...
                        :value="saveInstancePrints" @change="setSaveInstancePrints()" :long-label="true" />
                    <simple-switch :label="t('view.settings.advanced.advanced.save_instance_prints_to_file.crop')"
                        :value="cropInstancePrints" @change="setCropInstancePrints()" :long-label="true" />
                    <br />
                    <span class="sub-header">{{
                    ...
                    <simple-switch
                        ...
                        :value="saveInstanceStickers" @change="setSaveInstanceStickers()" :long-label="true" />
                    <br />
                    <span class="sub-header">{{ t('view.settings.advanced.advanced.save_instance_emoji_to_file.header')
                        }}
                    </span>
                    <el-tooltip placement="top" style="margin-left: 5px"
                        :content="t('view.settings.advanced.advanced.save_instance_prints_to_file.header_tooltip')">
                    ...
                    <simple-switch :label="t('view.settings.advanced.advanced.save_instance_emoji_to_file.description')"
                        :value="saveInstanceEmoji" @change="setSaveInstanceEmoji()" :long-label="true" />
                </div>
            </el-tab-pane>
            ...
            <el-tab-pane lazy :label="t('view.settings.category.advanced')">
                ...
                <div class="options-container" style="margin-top: 0">
                    ...
                    <div class="options-container-item" style="margin-top: 15px">
                        <el-button-group>
                            <el-button size="small" icon="el-icon-s-operation" @click="showVRChatConfig()">VRChat
                                config.json</el-button>
                ...
                <div class="options-container">
                    ...
                    <div class="options-container-item" style="margin-top: 15px">
                        <el-button-group>
                            <el-button size="small" icon="el-icon-folder" @click="openVrcxAppDataFolder()">VRCX
                                Data</el-button>
                            <el-button size="small" icon="el-icon-folder" @click="openVrcAppDataFolder()">VRChat
                                Data</el-button>
                            <el-button size="small" icon="el-icon-folder" @click="openCrashVrcCrashDumps()">Crash
                                Dumps</el-button>
                        </el-button-group>
                    </div>
                </div>
                ...
                <div class="options-container">
                    ...
                    <simple-switch :label="t('view.settings.advanced.advanced.primary_password.description')"
                        :value="enablePrimaryPassword" :disabled="!enablePrimaryPassword" :long-label="true"
                        @change="enablePrimaryPasswordChange" />

                    <span class="sub-header">{{ t('view.settings.advanced.advanced.relaunch_vrchat.header') }}</span>
                    <simple-switch :label="t('view.settings.advanced.advanced.relaunch_vrchat.description')"
                        :value="relaunchVRChatAfterCrash" :long-label="true" @change="
                            setRelaunchVRChatAfterCrash();
                        saveOpenVROption();
                        "></simple-switch>
                    <!--//- Advanced | VRChat Quit Fix-->
                    <span class="sub-header">{{ t('view.settings.advanced.advanced.vrchat_quit_fix.header') }}</span>
                    <simple-switch :label="t('view.settings.advanced.advanced.vrchat_quit_fix.description')"
                        :value="vrcQuitFix" :long-label="true" @change="
                            setVrcQuitFix();
                        saveOpenVROption();
                        " />
                    ...
                    <simple-switch :label="t('view.settings.advanced.advanced.auto_cache_management.description')"
                        :value="autoSweepVRChatCache" :long-label="true" @change="
                            setAutoSweepVRChatCache();
                        saveOpenVROption();
                        " />
                    <span class="sub-header">{{ t('view.settings.advanced.advanced.self_invite.header') }}</span>
                    <simple-switch :label="t('view.settings.advanced.advanced.self_invite.description')"
                        :value="selfInviteOverride" :long-label="true" @change="
                ...
                <div class="options-container">
                    ...
                    <simple-switch :label="t('view.settings.advanced.advanced.remote_database.enable')"
                        :value="avatarRemoteDatabase" :long-label="true" @change="
                ...
                <template v-if="!isLinux">
                    <div class="options-container">
                        ...
                        <br />
                        <el-button size="small" icon="el-icon-folder" style="margin-top: 5px"
                            @click="openShortcutFolder()">{{ t('view.settings.advanced.advanced.app_launcher.folder')
                            }}</el-button>
                        <el-tooltip placement="top" style="margin-left: 5px"
                        ...
                        <simple-switch :label="t('view.settings.advanced.advanced.remote_database.enable')"
                            :value="enableAppLauncher" :long-label="true" @change="setEnableAppLauncher" />
                        <simple-switch :label="t('view.settings.advanced.advanced.app_launcher.auto_close')"
                            :value="enableAppLauncherAutoClose" :long-label="true"
                            @change="setEnableAppLauncherAutoClose" />
                        <simple-switch :label="t('view.settings.advanced.advanced.app_launcher.run_process_once')"
                            :value="enableAppLauncherRunProcessOnce" :long-label="true"
                ...
                <div class="options-container">
                    ...
                    <simple-switch :label="t('view.settings.advanced.advanced.youtube_api.enable')" :value="youTubeApi"
                        :tooltip="t('view.settings.advanced.advanced.youtube_api.enable_tooltip')" :long-label="true"
                ...
                <div class="options-container">
                    ...
                    <simple-switch :label="t('view.settings.advanced.advanced.video_progress_pie.enable')"
                        :value="progressPie" :disabled="!openVR"
                        :tooltip="t('view.settings.advanced.advanced.video_progress_pie.enable_tooltip')"
                        :long-label="true" @change="changeYouTubeApi('VRCX_progressPie')" />
                    <simple-switch :label="t('view.settings.advanced.advanced.video_progress_pie.dance_world_only')"
                        :value="progressPieFilter" :disabled="!openVR" :long-label="true"
                ...
                <div class="options-container">
                    ...
                    <simple-switch :label="t(
                        ...
                        " :value="showConfirmationOnSwitchAvatar" :tooltip="t(
                            'view.settings.advanced.advanced.launch_commands.show_confirmation_on_switch_avatar_tooltip'
                        )
                            " :long-label="true" @change="setShowConfirmationOnSwitchAvatar" />
                    <div class="options-container-item">
                        <el-button size="small" icon="el-icon-paperclip" @click="
                ...
                <div v-if="photonLoggingEnabled" class="options-container">
                    ...
                    <div class="options-container-item">
                        ...
                        <simple-switch :label="t('view.settings.advanced.photon.event_hud.enable')"
                            :value="photonEventOverlay" :disabled="!openVR"
                    ...
                    <div class="options-container-item">
                        ...
                        <el-radio-group :value="photonEventOverlayFilter" size="mini"
                            :disabled="!openVR || !photonEventOverlay" @input="
                    ...
                    <div class="options-container-item">
                        <el-button size="small" icon="el-icon-time" :disabled="!openVR"
                            @click="promptPhotonOverlayMessageTimeout">{{
                                t('view.settings.advanced.photon.event_hud.message_timeout') }}</el-button>
                    </div>
                    <div class="options-container-item">
                        <el-select :value="photonEventTableTypeOverlayFilter" multiple clearable collapse-tags
                            style="flex: 1" placeholder="Filter" @input="
                                setPhotonEventTableTypeOverlayFilter($event);
                            photonEventTableFilterChange();
                            ">
                            <el-option v-for="type in photonEventTableTypeFilterList" :key="type" :label="type"
                                :value="type"></el-option>
                        </el-select>
                    </div>
                    <br />
                    <span class="sub-header">{{ t('view.settings.advanced.photon.timeout_hud.header') }}</span>
                    <simple-switch :label="t('view.settings.advanced.photon.timeout_hud.enable')"
                        :value="timeoutHudOverlay" :disabled="!openVR"
                    ...
                    <div class="options-container-item">
                        ...
                        <el-radio-group :value="timeoutHudOverlayFilter" size="mini"
                            :disabled="!openVR || !timeoutHudOverlay" @input="
                ...
                <div class="options-container">
                    ...
                    <simple-switch :label="t('view.settings.advanced.advanced.cache_debug.disable_gamelog')"
                        :value="gameLogDisabled" :long-label="true" @change="disableGameLogDialog()" />
                    <div class="options-container-item">
                    ...
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.cache_debug.user_cache') }}
                            <span v-text="cachedUsers.size"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.cache_debug.world_cache') }}
                            <span v-text="cachedWorlds.size"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.cache_debug.avatar_cache') }}
                            <span v-text="cachedAvatars.size"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.cache_debug.group_cache') }}
                            <span v-text="cachedGroups.size"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.cache_debug.avatar_name_cache') }}
                            <span v-text="cachedAvatarNames.size"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.cache_debug.instance_cache') }}
                            <span v-text="cachedInstances.size"></span></span>
                    </div>
                    <div class="options-container-item">
                ...
                <div class="options-container">
                    ...
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.sqlite_table_size.gps') }}
                            <span v-text="sqliteTableSizes.gps"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.sqlite_table_size.status') }}
                            <span v-text="sqliteTableSizes.status"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.sqlite_table_size.bio') }}
                            <span v-text="sqliteTableSizes.bio"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.sqlite_table_size.avatar') }}
                            <span v-text="sqliteTableSizes.avatar"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.sqlite_table_size.online_offline') }}
                            <span v-text="sqliteTableSizes.onlineOffline"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.sqlite_table_size.friend_log_history')
                            }}
                            <span v-text="sqliteTableSizes.friendLogHistory"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.sqlite_table_size.notification') }}
                            <span v-text="sqliteTableSizes.notification"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.sqlite_table_size.location') }}
                            <span v-text="sqliteTableSizes.location"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.sqlite_table_size.join_leave') }}
                            <span v-text="sqliteTableSizes.joinLeave"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.sqlite_table_size.portal_spawn') }}
                            <span v-text="sqliteTableSizes.portalSpawn"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.sqlite_table_size.video_play') }}
                            <span v-text="sqliteTableSizes.videoPlay"></span></span>
                    </div>
                    <div class="options-container-item">
                        <span class="name">{{ t('view.settings.advanced.advanced.sqlite_table_size.event') }}
                            <span v-text="sqliteTableSizes.event"></span></span>
                    </div>
                </div>
            </el-tab-pane>
        </el-tabs>
