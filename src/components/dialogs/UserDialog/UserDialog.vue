<template>
    <safe-dialog ref="userDialogRef" class="x-dialog x-user-dialog" :visible.sync="userDialog.visible"
        :show-close="false" width="770px">
        <div v-loading="userDialog.loading">
            <div style="display: flex">
                <el-popover v-if="
                    !userDialog.loading &&
                    (userDialog.ref.profilePicOverrideThumbnail || userDialog.ref.profilePicOverride)
                " placement="right" width="500px" trigger="click">
                    <img slot="reference" class="x-link"
                    ...
                    <img v-lazy="userDialog.ref.profilePicOverride" class="x-link" style="height: 400px"
                ...
                <el-popover v-else-if="!userDialog.loading" placement="right" width="500px" trigger="click">
                    <img slot="reference" class="x-link" :src="userDialog.ref.currentAvatarThumbnailImageUrl"
                        style="flex: none; height: 120px; width: 160px; border-radius: 12px; object-fit: cover" />
                    <img v-lazy="userDialog.ref.currentAvatarImageUrl" class="x-link" style="height: 500px"
                ...
                <div style="flex: 1; display: flex; align-items: center; margin-left: 15px">
                    <div style="flex: 1">
                        <div>
                            ...
                            <template v-if="userDialog.previousDisplayNames.length > 0">
                                <el-tooltip placement="bottom">
                                    <template #content>
                                        ...
                                        <div v-for="displayName in userDialog.previousDisplayNames" :key="displayName"
                                            placement="top">
                            ...
                            <el-popover placement="top" trigger="click">
                                <span slot="reference" class="dialog-title"
                            ...
                            <el-tooltip v-if="userDialog.ref.pronouns" placement="top"
                                :content="t('dialog.user.pronouns')" :disabled="hideTooltips">
                                <span class="x-grey" style="margin-right: 5px; font-family: monospace; font-size: 12px"
                            ...
                            <el-tooltip v-for="item in userDialog.ref.$languages" :key="item.key" placement="top">
                                ...
                                <span class="flags" :class="languageClass(item.key)"
                                    style="display: inline-block; margin-right: 5px"></span>
                            </el-tooltip>
                            <template v-if="userDialog.ref.id === currentUser.id">
                                <br />
                                <el-popover placement="top" trigger="click">
                                    <span slot="reference" class="x-grey" style="
                                            margin-right: 10px;
                        ...
                        <div style="margin-top: 5px" v-show="!userDialog.loading">
                            <el-tag type="info" effect="plain" size="mini" class="name"
                                :class="userDialog.ref.$trustClass" style="margin-right: 5px; margin-top: 5px">
                                {{ userDialog.ref.$trustLevel }}
                            </el-tag>
                            <el-tag v-if="userDialog.isFriend && userDialog.friend" type="info" effect="plain"
                                size="mini" class="x-tag-friend" style="margin-right: 5px; margin-top: 5px">
                                {{
                            ...
                            <el-tag v-if="userDialog.ref.$isTroll" type="info" effect="plain" size="mini"
                                class="x-tag-troll" style="margin-right: 5px; margin-top: 5px">
                                Nuisance
                            </el-tag>
                            <el-tag v-if="userDialog.ref.$isProbableTroll" type="info" effect="plain" size="mini"
                                class="x-tag-troll" style="margin-right: 5px; margin-top: 5px">
                                Almost Nuisance
                            </el-tag>
                            <el-tag v-if="userDialog.ref.$isModerator" type="info" effect="plain" size="mini"
                                class="x-tag-vip" style="margin-right: 5px; margin-top: 5px">
                                {{ t('dialog.user.tags.vrchat_team') }}
                            </el-tag>
                            <el-tag v-if="userDialog.ref.$platform === 'standalonewindows'" type="info" effect="plain"
                                size="mini" class="x-tag-platform-pc" style="margin-right: 5px; margin-top: 5px">
                                PC
                            </el-tag>
                            <el-tag v-else-if="userDialog.ref.$platform === 'android'" type="info" effect="plain"
                                size="mini" class="x-tag-platform-quest" style="margin-right: 5px; margin-top: 5px">
                                Android
                            </el-tag>
                            <el-tag v-else-if="userDialog.ref.$platform === 'ios'" type="info" effect="plain"
                                size="mini" class="x-tag-platform-ios"
                                style="margin-right: 5px; margin-top: 5px">iOS</el-tag>
                            <el-tag v-else-if="userDialog.ref.$platform" type="info" effect="plain" size="mini"
                                class="x-tag-platform-other" style="margin-right: 5px; margin-top: 5px">
                                {{ userDialog.ref.$platform }}
                            </el-tag>
                            <el-tag v-if="userDialog.ref.ageVerified && userDialog.ref.ageVerificationStatus"
                                type="info" effect="plain" size="mini" class="x-tag-age-verification"
                            ...
                            <el-tag v-if="userDialog.ref.$customTag" type="info" effect="plain" size="mini" class="name"
                                :style="{
                                    color: userDialog.ref.$customTagColour,
                                    'border-color': userDialog.ref.$customTagColour
                                }" style="margin-right: 5px; margin-top: 5px">{{ userDialog.ref.$customTag }}</el-tag>
                            <br />
                            <el-tooltip v-show="!userDialog.loading" v-for="badge in userDialog.ref.badges"
                                :key="badge.badgeId" placement="top">
                                <template #content>
                                    <span>{{ badge.badgeName }}</span>
                                    <span v-if="badge.hidden">&nbsp;(Hidden)</span>
                                </template>
                                <el-popover placement="right" width="300px" trigger="click">
                                    <img slot="reference" class="x-link x-user-badge" :src="badge.badgeImageUrl" style="
                                            flex: none;
                                            height: 32px;
                                            width: 32px;
                                            border-radius: 3px;
                                    ...
                                    <img v-lazy="badge.badgeImageUrl" class="x-link" style="width: 300px"
                                    ...
                                    <div style="display: block; width: 300px; word-break: normal">
                                        ...
                                        <br />
                                        <span v-if="badge.assignedAt" class="x-grey"
                                        ...
                                        <template v-if="userDialog.id === currentUser.id">
                                            <br />
                                            <el-checkbox v-model="badge.hidden" style="margin-top: 5px"
                                                @change="toggleBadgeVisibility(badge)">
                                                {{ t('dialog.user.badges.hidden') }}
                                            </el-checkbox>
                                            <br />
                                            <el-checkbox v-model="badge.showcased" style="margin-top: 5px"
                    ...
                    <div v-if="userDialog.ref.userIcon" style="flex: none; margin-right: 10px">
                        <el-popover placement="right" width="500px" trigger="click">
                            <img slot="reference" class="x-link" :src="userImage(userDialog.ref, true, '256', true)"
                                style="
                                    flex: none;
                                    width: 120px;
                                    height: 120px;
                                    ...
                                    object-fit: cover;
                                " />
                            <img v-lazy="userDialog.ref.userIcon" class="x-link" style="height: 500px"
                    ...
                    <div style="flex: none">
                        ...
                        ">
                            <el-tooltip v-if="userDialog.isFavorite" placement="top"
                                :content="t('dialog.user.actions.unfavorite_tooltip')" :disabled="hideTooltips">
                            ...
                            <el-tooltip v-else placement="top" :content="t('dialog.user.actions.favorite_tooltip')"
                                ...
                                <el-button type="default" icon="el-icon-star-off" circle
                                    @click="userDialogCommand('Add Favorite')"></el-button>
                            </el-tooltip>
                        </template>
                        <el-dropdown trigger="click" size="small" @command="userDialogCommand">
                            <el-button :type="userDialog.incomingRequest || userDialog.outgoingRequest
                                ...
                                : userDialog.isBlock || userDialog.isMute
                                    ? 'danger'
                                    : 'default'
                                " icon="el-icon-more" circle style="margin-left: 5px"></el-button>
                            <el-dropdown-menu slot="dropdown">
                                ...
                                <template v-else>
                                    <template v-if="userDialog.isFriend">
                                        ...
                                        <template v-if="isGameRunning">
                                            <el-dropdown-item :disabled="!checkCanInvite(lastLocation.location)"
                                                icon="el-icon-message" command="Invite">{{
                                                    t('dialog.user.actions.invite') }}</el-dropdown-item>
                                            <el-dropdown-item :disabled="!checkCanInvite(lastLocation.location)"
                                                icon="el-icon-message" command="Invite Message">{{
                                    ...
                                    <el-dropdown-item v-else-if="userDialog.outgoingRequest" icon="el-icon-close"
                                    ...
                                    <el-dropdown-item v-if="userDialog.ref.currentAvatarImageUrl"
                                        icon="el-icon-picture-outline" command="Previous Images">
                                        {{ t('dialog.user.actions.show_previous_images') }}
                                    </el-dropdown-item>
                                    <el-dropdown-item v-if="userDialog.isBlock" icon="el-icon-circle-check"
                                        command="Moderation Unblock" divided style="color: #f56c6c">
                                        {{ t('dialog.user.actions.moderation_unblock') }}
                                    </el-dropdown-item>
                                    <el-dropdown-item v-else icon="el-icon-circle-close" command="Moderation Block"
                                        divided :disabled="userDialog.ref.$isModerator">
                                        {{ t('dialog.user.actions.moderation_block') }}
                                    </el-dropdown-item>
                                    <el-dropdown-item v-if="userDialog.isMute" icon="el-icon-microphone"
                                        command="Moderation Unmute" style="color: #f56c6c">
                                        {{ t('dialog.user.actions.moderation_unmute') }}
                                    </el-dropdown-item>
                                    <el-dropdown-item v-else icon="el-icon-turn-off-microphone"
                                        command="Moderation Mute" :disabled="userDialog.ref.$isModerator">
                                        {{ t('dialog.user.actions.moderation_mute') }}
                                    </el-dropdown-item>
                                    <el-dropdown-item v-if="userDialog.isMuteChat" icon="el-icon-chat-line-round"
                                        command="Moderation Enable Chatbox" style="color: #f56c6c">
                                        {{ t('dialog.user.actions.moderation_enable_chatbox') }}
                                    </el-dropdown-item>
                                    <el-dropdown-item v-else icon="el-icon-chat-dot-round"
                                    ...
                                    <el-dropdown-item v-if="userDialog.isInteractOff" icon="el-icon-thumb"
                                        command="Moderation Enable Avatar Interaction" style="color: #f56c6c">
                                        {{ t('dialog.user.actions.moderation_enable_avatar_interaction') }}
                                    </el-dropdown-item>
                                    <el-dropdown-item v-else icon="el-icon-circle-close"
                                        command="Moderation Disable Avatar Interaction">
                                        {{ t('dialog.user.actions.moderation_disable_avatar_interaction') }}
                                    </el-dropdown-item>
                                    <el-dropdown-item icon="el-icon-s-flag" command="Report Hacking"
                                        :disabled="userDialog.ref.$isModerator">
                                        {{ t('dialog.user.actions.report_hacking') }}
                                    </el-dropdown-item>
                                    <template v-if="userDialog.isFriend">
                                        <el-dropdown-item icon="el-icon-delete" command="Unfriend" divided
                                            style="color: #f56c6c">
            ...
            <el-tabs ref="userDialogTabsRef" @tab-click="userDialogTabClick">
                <el-tab-pane name="Info" :label="t('dialog.user.info.header')">
                    <template v-if="isFriendOnline(userDialog.friend) || currentUser.id === userDialog.id">
                        <div v-if="userDialog.ref.location" style="
                                display: flex;
                            ...
                            <div style="flex: none">
                                <template v-if="isRealInstance(userDialog.$location.tag)">
                                    ...
                                    <InviteYourself :location="userDialog.$location.tag"
                                        :shortname="userDialog.$location.shortName" style="margin-left: 5px" />
                                    <el-tooltip placement="top" :content="t('dialog.user.info.refresh_instance_info')"
                                        :disabled="hideTooltips">
                                        <el-button size="mini" icon="el-icon-refresh" style="margin-left: 5px" circle
                                            @click="refreshInstancePlayerCount(userDialog.$location.tag)"></el-button>
                                    </el-tooltip>
                                    <LastJoin :location="userDialog.$location.tag"
                                        :currentlocation="lastLocation.location" />
                                    <InstanceInfo :location="userDialog.$location.tag"
                            ...
                            <div class="x-friend-list" style="flex: 1; margin-top: 10px; max-height: 150px">
                                <div v-if="userDialog.$location.userId" class="x-friend-item x-friend-item-border"
                                    ...
                                    <template v-if="userDialog.$location.user">
                                        ...
                                        <div class="detail">
                                            <span class="name" :style="{ color: userDialog.$location.user.$userColour }"
                                ...
                                <div v-for="user in userDialog.users" :key="user.id"
                                    class="x-friend-item x-friend-item-border" @click="showUserDialog(user.id)">
                                    <div class="avatar" :class="userStatusClass(user)">
                                        <img :src="userImage(user, true)" />
                                    </div>
                                    <div class="detail">
                                        <span class="name" :style="{ color: user.$userColour }"
                    ...
                    <div class="x-friend-list" style="max-height: none">
                        <div v-if="!hideUserNotes" class="x-friend-item" style="width: 100%; cursor: default">
                            <div class="detail">
                                ...
                                <el-input v-model="userDialog.note" type="textarea" maxlength="256" show-word-limit
                                    :rows="2" :autosize="{ minRows: 1, maxRows: 20 }"
                                    :placeholder="t('dialog.user.info.note_placeholder')" size="mini" resize="none"
                                    @change="checkNote(userDialog.ref, userDialog.note)"
                                    @input="cleanNote(userDialog.note)"></el-input>
                                <div style="float: right">
                                    <i v-if="userDialog.noteSaving" class="el-icon-loading"
                                        style="margin-left: 5px"></i>
                                    <i v-else-if="userDialog.note !== userDialog.ref.note" class="el-icon-more-outline"
                                        style="margin-left: 5px"></i>
                                    <el-button v-if="userDialog.note" type="text" icon="el-icon-delete" size="mini"
                                        style="margin-left: 5px" @click="deleteNote(userDialog.id)"></el-button>
                                </div>
                            </div>
                        </div>
                        <div v-if="!hideUserMemos" class="x-friend-item" style="width: 100%; cursor: default">
                            <div class="detail">
                                ...
                                <el-input v-model="userDialog.memo" class="extra" type="textarea" :rows="2"
                                    :autosize="{ minRows: 1, maxRows: 20 }"
                                    :placeholder="t('dialog.user.info.memo_placeholder')" size="mini" resize="none"
                        ...
                        <div class="x-friend-item" style="width: 100%; cursor: default">
                            <div class="detail">
                                ...
                                <div class="extra">
                                    <AvatarInfo :imageurl="userDialog.ref.currentAvatarImageUrl" :userid="userDialog.id"
                                        :avatartags="userDialog.ref.currentAvatarTags" style="display: inline-block" />
                                    <el-tooltip v-if="
                                        userDialog.ref.profilePicOverride &&
                                        !userDialog.ref.currentAvatarImageUrl &&
                                        !hideTooltips
                                    " placement="top" :content="t('dialog.user.info.vrcplus_hides_avatar')">
                            ...
                            <div class="detail">
                                ...
                                " class="extra">
                                    <div style="display: inline-block; flex: none; margin-right: 5px">
                                        <el-popover placement="right" width="500px" trigger="click">
                                            <el-image slot="reference" v-loading="userDialog.isRepresentedGroupLoading"
                                                class="x-link" :src="userDialog.representedGroup.$thumbnailUrl" style="
                                                    flex: none;
                                                    width: 60px;
                                                    height: 60px;
                                                    border-radius: 4px;
                                            ...
                                            <img v-lazy="userDialog.representedGroup.iconUrl" class="x-link"
                                                style="height: 500px" @click="
                                                    showFullscreenImageDialog(userDialog.representedGroup.iconUrl)
                                                    " />
                                        </el-popover>
                                    </div>
                                    <span v-if="userDialog.representedGroup.isRepresenting"
                        ...
                        <div class="x-friend-item" style="width: 100%; cursor: default">
                            <div class="detail">
                                ...
                                <div v-if="userDialog.id === currentUser.id" style="float: right">
                                    <el-button type="text" icon="el-icon-edit" size="mini" style="margin-left: 5px"
                                ...
                                <div style="margin-top: 5px">
                                    <el-tooltip v-for="(link, index) in userDialog.ref.bioLinks" :key="index">
                                        ...
                                        <img :src="getFaviconUrl(link)"
                                            onerror="this.onerror=null;this.class='el-icon-error'" style="
                                                width: 16px;
                                                height: 16px;
                        ...
                        <template v-if="currentUser.id !== userDialog.id">
                            ...
                            <el-tooltip :disabled="hideTooltips" placement="top"
                        ...
                        <template v-else>
                            <el-tooltip :disabled="hideTooltips || currentUser.id !== userDialog.id" placement="top"
                                :content="t('dialog.user.info.open_previous_instance')">
                                <div class="x-friend-item" @click="showPreviousInstancesUserDialog(userDialog.ref)">
                                    <div class="detail">
                                        <span class="name">
                        ...
                        <div class="x-friend-item" style="cursor: default">
                            <el-tooltip :placement="currentUser.id !== userDialog.id ? 'bottom' : 'top'">
                                ...
                                <div class="detail">
                                    <span v-if="userDialog.ref.state === 'online' && userDialog.ref.$online_for"
                                        class="name">
                        ...
                        <div class="x-friend-item" style="cursor: default">
                            <el-tooltip :placement="currentUser.id !== userDialog.id ? 'bottom' : 'top'">
                                <template #content>
                                    <span>{{ t('dialog.user.info.last_login') }}
                                        {{ formatDateFilter(userDialog.ref.last_login, 'long') }}</span>
                                    <br />
                                    <span>{{ t('dialog.user.info.last_activity') }}
                            ...
                            <el-tooltip placement="top" :disabled="!userDialog.dateFriendedInfo.length">
                                <template v-if="userDialog.dateFriendedInfo.length" #content>
                                    <template v-for="ref in userDialog.dateFriendedInfo">
                                        <span :key="ref.userId">{{ ref.type }}: {{ formatDateFilter(ref.created_at,
                                            'long') }}</span><br :key="ref.userId + 'br'" />
                                    </template>
                                </template>
                                <div class="detail">
                            ...
                            <div class="x-friend-item" style="cursor: default">
                                <div class="detail">
                                    ...
                                    <span v-if="userDialog.ref.allowAvatarCopying" class="extra"
                                        style="color: #67c23a">{{ t('dialog.user.info.avatar_cloning_allow') }}</span>
                                    <span v-else class="extra" style="color: #f56c6c">{{
                                        t('dialog.user.info.avatar_cloning_deny')
                                    }}</span>
                                </div>
                        ...
                        <div v-if="userDialog.ref.id === currentUser.id && currentUser.homeLocation"
                            class="x-friend-item" style="width: 100%"
                            ...
                            <div class="detail">
                                ...
                                <span class="extra">
                                    ...
                                    <el-button size="mini" icon="el-icon-delete" circle style="margin-left: 5px"
                                ...
                                <span class="extra">
                                    ...
                                    <el-tooltip placement="top" :content="t('dialog.user.info.id_tooltip')"
                                        ...
                                        <el-dropdown trigger="click" size="mini" style="margin-left: 5px"
                                            @click.native.stop>
                                            <el-button type="default" icon="el-icon-s-order" size="mini"
                                                circle></el-button>
                                            <el-dropdown-menu slot="dropdown">
                ...
                <el-tab-pane name="Groups" :label="t('dialog.user.groups.header')" lazy>
                    <div style="display: flex; align-items: center; justify-content: space-between">
                        <div style="display: flex; align-items: center">
                            <el-button type="default" :loading="userDialog.isGroupsLoading" size="mini"
                                icon="el-icon-refresh" circle @click="getUserGroups(userDialog.id)">
                            </el-button>
                        ...
                        <div style="display: flex; align-items: center">
                            <template v-if="!userDialogGroupEditMode">
                                ...
                                <el-dropdown trigger="click" size="small" style="margin-right: 5px"
                                    :disabled="userDialog.isGroupsLoading" @click.native.stop>
                                    <el-button size="mini">
                                        <span>{{ t(userDialog.groupSorting.name) }}
                                            <i class="el-icon-arrow-down el-icon--right"></i></span>
                                    </el-button>
                                    <el-dropdown-menu slot="dropdown">
                                        <el-dropdown-item v-for="(item, key) in userDialogGroupSortingOptions"
                                            :key="key" :disabled="item === userDialogGroupSortingOptions.inGame &&
                                                userDialog.id !== currentUser.id
                                                " @click.native="setUserDialogGroupSorting(item)">{{ t(item.name) }}
                                        </el-dropdown-item>
                                    </el-dropdown-menu>
                                </el-dropdown>
                            </template>
                            <el-button v-if="userDialogGroupEditMode" size="small" icon="el-icon-edit"
                            ...
                            <el-button v-else-if="currentUser.id === userDialog.id" size="small" icon="el-icon-edit"
                                style="margin-right: 5px; height: 29px; padding: 7px 15px"
                    ...
                    <div v-loading="userDialog.isGroupsLoading" style="margin-top: 10px">
                        <template v-if="userDialogGroupEditMode">
                            <div class="x-friend-list" style="margin-top: 10px; margin-bottom: 15px; max-height: unset">
                                ...
                                <div v-for="group in userDialogGroupEditGroups" :key="group.id"
                                    class="x-friend-item x-friend-item-border" style="width: 100%"
                                    ...
                                    <div style="margin-right: 3px; margin-left: 5px" @click.stop>
                                        <el-button size="mini" icon="el-icon-download" style="
                                                display: block;
                                                padding: 7px;
                                                font-size: 9px;
                                                margin-left: 0;
                                    ...
                                    <div class="detail">
                                        ...
                                        <span class="extra">
                                            <el-tooltip v-if="group.isRepresenting" placement="top"
                                            ...
                                            <el-tooltip v-if="group.myMember.visibility !== 'visible'" placement="top">
                                                <template #content>
                                                    <span>{{ t('dialog.group.members.visibility') }}
                                    ...
                                    <el-dropdown :disabled="group.privacy !== 'default'" trigger="click" size="small"
                                        style="margin-right: 5px" @click.native.stop>
                                        <el-button size="mini">
                                        ...
                                        <el-dropdown-menu>
                                            <el-dropdown-item @click.native="setGroupVisibility(group.id, 'visible')"><i
                                                    v-if="group.myMember.visibility === 'visible'"
                                                    class="el-icon-check"></i>
                                                {{ t('dialog.group.actions.visibility_everyone') }}</el-dropdown-item>
                                            <el-dropdown-item @click.native="setGroupVisibility(group.id, 'friends')"><i
                                                    v-if="group.myMember.visibility === 'friends'"
                                                    class="el-icon-check"></i>
                                                {{ t('dialog.group.actions.visibility_friends') }}</el-dropdown-item>
                                            <el-dropdown-item @click.native="setGroupVisibility(group.id, 'hidden')"><i
                                    ...
                                    <el-tooltip placement="right" :content="t('dialog.user.groups.leave_group_tooltip')"
                                        :disabled="hideTooltips">
                                        <el-button v-if="shiftHeld" size="mini" icon="el-icon-close" circle
                                            style="color: #f56c6c; margin-left: 5px" @click.stop="leaveGroup(group.id)">
                                        </el-button>
                                        <el-button v-else size="mini" icon="el-icon-delete" circle
                                            style="margin-left: 5px" @click.stop="leaveGroupPrompt(group.id)">
                                        </el-button>
                                    </el-tooltip>
                                </div>
                            </div>
                        ...
                        <template v-else>
                            <template v-if="userGroups.ownGroups.length > 0">
                                ...
                                <div class="x-friend-list"
                                    ...
                                    <div v-for="group in userGroups.ownGroups" :key="group.id"
                                        class="x-friend-item x-friend-item-border" @click="showGroupDialog(group.id)">
                                        <div class="avatar">
                                            <img v-lazy="group.iconUrl" />
                                        </div>
                                        <div class="detail">
                            ...
                            <template v-if="userGroups.mutualGroups.length > 0">
                                ...
                                <div class="x-friend-list"
                                    style="margin-top: 10px; margin-bottom: 15px; min-height: 60px">
                                    <div v-for="group in userGroups.mutualGroups" :key="group.id"
                                        class="x-friend-item x-friend-item-border" @click="showGroupDialog(group.id)">
                                        <div class="avatar">
                                            <img v-lazy="group.iconUrl" />
                                        </div>
                            ...
                            <template v-if="userGroups.remainingGroups.length > 0">
                                ...
                                <div class="x-friend-list"
                                    style="margin-top: 10px; margin-bottom: 15px; min-height: 60px">
                                    <div v-for="group in userGroups.remainingGroups" :key="group.id"
                                        class="x-friend-item x-friend-item-border" @click="showGroupDialog(group.id)">
                                        <div class="avatar">
                                            <img v-lazy="group.iconUrl" />
                                        </div>
                ...
                <el-tab-pane name="Worlds" :label="t('dialog.user.worlds.header')" lazy>
                    <div style="display: flex; align-items: center; justify-content: space-between">
                        <div style="display: flex; align-items: center">
                            <el-button type="default" :loading="userDialog.isWorldsLoading" size="mini"
                                icon="el-icon-refresh" circle @click="refreshUserDialogWorlds()">
                            </el-button>
                            <span style="margin-left: 5px">{{
                        ...
                        <div style="display: flex; align-items: center">
                            ...
                            <el-dropdown trigger="click" size="small" style="margin-right: 5px"
                                :disabled="userDialog.isWorldsLoading" @click.native.stop>
                                <el-button size="mini">
                                    <span>{{ t(userDialog.worldSorting.name) }}
                                        <i class="el-icon-arrow-down el-icon--right"></i></span>
                                </el-button>
                                <el-dropdown-menu slot="dropdown">
                                    <el-dropdown-item v-for="(item, key) in userDialogWorldSortingOptions" :key="key"
                            ...
                            <el-dropdown trigger="click" size="small" style="margin-right: 5px"
                                :disabled="userDialog.isWorldsLoading" @click.native.stop>
                                <el-button size="mini">
                                    <span>{{ t(userDialog.worldOrder.name) }}
                                        <i class="el-icon-arrow-down el-icon--right"></i></span>
                                </el-button>
                                <el-dropdown-menu slot="dropdown">
                                    <el-dropdown-item v-for="(item, key) in userDialogWorldOrderOptions" :key="key"
                    ...
                    <div v-loading="userDialog.isWorldsLoading" class="x-friend-list"
                        style="margin-top: 10px; min-height: 60px">
                        <div v-for="world in userDialog.worlds" :key="world.id"
                            class="x-friend-item x-friend-item-border" @click="showWorldDialog(world.id)">
                            <div class="avatar">
                ...
                <el-tab-pane name="Favorite Worlds" :label="t('dialog.user.favorite_worlds.header')" lazy>
                    <el-button v-if="userFavoriteWorlds && userFavoriteWorlds.length > 0" type="default"
                        :loading="userDialog.isFavoriteWorldsLoading" size="small" icon="el-icon-refresh" circle
                        style="position: absolute; right: 15px; bottom: 15px; z-index: 99"
                        @click="getUserFavoriteWorlds(userDialog.id)">
                    </el-button>
                    <el-tabs ref="favoriteWorldsRef" v-loading="userDialog.isFavoriteWorldsLoading"
                        class="zero-margin-tabs" type="card" stretch style="margin-top: 10px; height: 50vh">
                        <template v-if="userFavoriteWorlds && userFavoriteWorlds.length > 0">
                            <el-tab-pane v-for="(list, index) in userFavoriteWorlds" :key="index" lazy>
                                <span slot="label">
                                    <i class="x-status-icon" style="margin-right: 6px"
                                        :class="userFavoriteWorldsStatus(list[1])">
                                    </i>
                                    <span style="font-weight: bold; font-size: 14px" v-text="list[0]"></span>
                                    <span style="color: #909399; font-size: 10px; margin-left: 5px">{{ list[2].length
                                    }}/{{ favoriteLimits.maxFavoritesPerGroup.world }}</span>
                                </span>
                                <div class="x-friend-list"
                                    style="margin-top: 10px; margin-bottom: 15px; min-height: 60px; max-height: none">
                                    <div v-for="world in list[2]" :key="world.favoriteId"
                                        class="x-friend-item x-friend-item-border" @click="showWorldDialog(world.id)">
                                        <div class="avatar">
                                            <img v-lazy="world.thumbnailImageUrl" />
                                        </div>
                ...
                <el-tab-pane name="Avatars" :label="t('dialog.user.avatars.header')" lazy>
                    <div style="display: flex; align-items: center; justify-content: space-between">
                        <div style="display: flex; align-items: center">
                            <el-button v-if="userDialog.ref.id === currentUser.id" type="default"
                                :loading="userDialog.isAvatarsLoading" size="mini" icon="el-icon-refresh" circle
                                @click="refreshUserDialogAvatars()">
                            </el-button>
                            <el-button v-else type="default" :loading="userDialog.isAvatarsLoading" size="mini"
                                icon="el-icon-refresh" circle @click="setUserDialogAvatarsRemote(userDialog.id)">
                            </el-button>
                            <span style="margin-left: 5px">{{
                        ...
                        <div>
                            <template v-if="userDialog.ref.id === currentUser.id">
                                ...
                                <el-dropdown trigger="click" size="small" style="margin-right: 5px"
                                    :disabled="userDialog.isWorldsLoading" @click.native.stop>
                                    <el-button size="mini">
                                        <span>{{ t(`dialog.user.avatars.sort_by_${userDialog.avatarSorting}`) }}
                                            <i class="el-icon-arrow-down el-icon--right"></i></span>
                                    </el-button>
                                    <el-dropdown-menu slot="dropdown">
                                ...
                                <el-dropdown trigger="click" size="small" style="margin-right: 5px"
                                    :disabled="userDialog.isWorldsLoading" @click.native.stop>
                                    <el-button size="mini">
                                        <span>{{ t(`dialog.user.avatars.${userDialog.avatarReleaseStatus}`) }}
                                            <i class="el-icon-arrow-down el-icon--right"></i></span>
                                    </el-button>
                                    <el-dropdown-menu slot="dropdown">
                    ...
                    <div class="x-friend-list" style="margin-top: 10px; min-height: 60px; max-height: 50vh">
                        <div v-for="avatar in userDialogAvatars" :key="avatar.id"
                            class="x-friend-item x-friend-item-border" @click="showAvatarDialog(avatar.id)">
                            <div class="avatar">
                                <img v-if="avatar.thumbnailImageUrl" v-lazy="avatar.thumbnailImageUrl" />
                            </div>
                            <div class="detail">
                                <span class="name" v-text="avatar.name"></span>
                                <span v-if="avatar.releaseStatus === 'public'" class="extra" style="color: #67c23a"
                                    v-text="avatar.releaseStatus">
                                </span>
                                <span v-else-if="avatar.releaseStatus === 'private'" class="extra"
                                    style="color: #f56c6c" v-text="avatar.releaseStatus">
                                </span>
                ...
                <el-tab-pane name="JSON" :label="t('dialog.user.json.header')" lazy style="height: 50vh">
                    <el-button type="default" size="mini" icon="el-icon-refresh" circle
                        @click="useVscodeLikeEditorToShowJSON ? refreshUserDialogData() : refreshUserDialogTreeData()">
                    </el-button>
                    <el-button type="default" size="mini" icon="el-icon-download" circle style="margin-left: 5px"
                        @click="downloadAndSaveJson(userDialog.id, userDialog.ref)">
                    </el-button>
                    <el-tree v-if="!useVscodeLikeEditorToShowJSON" :data="userDialog.treeData"
                    ...
                    <MonacoEditor v-else :value="formatJSON(userDialog.data)"
                        style="margin-top: 5px; font-size: 12px; min-height: 50vh;" />

                </el-tab-pane>
            </el-tabs>
        </div>
        <SendInviteDialog :send-invite-dialog-visible.sync="sendInviteDialogVisible"
            :send-invite-dialog="sendInviteDialog" @closeInviteDialog="closeInviteDialog" />
        <SendInviteRequestDialog :send-invite-request-dialog-visible.sync="sendInviteRequestDialogVisible"
            :send-invite-dialog="sendInviteDialog" @closeInviteDialog="closeInviteDialog" />
        <PreviousInstancesUserDialog :previous-instances-user-dialog.sync="previousInstancesUserDialog" />
        <PreviousImagesDialog />
        <InviteGroupDialog />
        <SocialStatusDialog :social-status-dialog="socialStatusDialog"
...
const { hideTooltips, hideUserNotes, hideUserMemos, useVscodeLikeEditorToShowJSON } = storeToRefs(useAppearanceSettingsStore());
const { avatarRemoteDatabase } = storeToRefs(useAdvancedSettingsStore());
const { userDialog, languageDialog, currentUser, cachedUsers } = storeToRefs(useUserStore());
const { showUserDialog, applyUser, sortUserDialogAvatars, refreshUserDialogAvatars, refreshUserDialogTreeData, refreshUserDialogData } =
    useUserStore();
