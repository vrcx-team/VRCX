...
class SQLiteService {
    handleSQLiteError(e) {
        if (typeof e.message !== 'string' || window.isVrOverlay) return;
        let modalStore;
        try {
            modalStore = useModalStore();
        } catch {
            // Pinia not initialized yet — log and bail during early startup
