...
import { APP_CJK_FONT_PACK_DEFAULT_KEY, APP_FONT_DEFAULT_KEY } from '../shared/constants';
...
export async function initUiForVrOverlay() {
    try {
        const [language, fontFamily, customFontFamily, cjkFontPack] = await Promise.all([
